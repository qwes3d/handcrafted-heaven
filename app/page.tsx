    ...
    <div>
      <section className="relative h-[80vh] bg-gradient-to-br from-purple-700 to-pink-500 flex items-center justify-center">
        <div className="text-center text-white z-10 px-4">
          ...
          <p className="text-lg md:text-2xl mb-8">Unique handmade crafts from talented artisans.</p>
          <Link href="/products" className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-6 rounded-lg transition">
            Browse Products
          </Link>
        </div>
      </section>
